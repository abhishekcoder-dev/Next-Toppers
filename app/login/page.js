    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="flex items-center justify-center min-h-[calc(100vh-80px)] px-6 py-16">
        <div className="max-w-md w-full">
          ...
          <div className="bg-gray-900/50 rounded-2xl p-8 border border-cyan-400/30 backdrop-blur-sm">
            ...
            <div className="mt-8">
              ...
              <div className="mt-6 grid grid-cols-2 gap-3">
                <button className="w-full inline-flex justify-center py-3 px-4 border border-gray-600 rounded-lg bg-gray-800 text-gray-300 hover:bg-gray-700 transition-colors duration-300">
          ...
          {/* Quick Access */}
          <div className="mt-8 bg-gray-900/30 rounded-2xl p-6 border border-gray-700">
            <h3 className="text-lg font-bold text-center text-gray-300 mb-4">Quick Access</h3>
            <div className="space-y-3">
              <button className="w-full px-4 py-3 bg-gray-800 border border-gray-600 rounded-lg text-gray-300 hover:border-green-400 hover:text-green-400 transition-all duration-300">
                📚 Access Study Materials
              </button>
              <button className="w-full px-4 py-3 bg-gray-800 border border-gray-600 rounded-lg text-gray-300 hover:border-yellow-400 hover:text-yellow-400 transition-all duration-300">
                📊 View Test Results
              </button>
              <button className="w-full px-4 py-3 bg-gray-800 border border-gray-600 rounded-lg text-gray-300 hover:border-purple-400 hover:text-purple-400 transition-all duration-300">
                🎥 Join Live Classes
              </button>
            </div>
          </div>
