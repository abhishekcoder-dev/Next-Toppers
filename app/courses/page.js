        ...
        {isMobileMenuOpen && (
          <div className="md:hidden bg-gray-900 border-t border-gray-700">
            <div className="px-6 py-4 space-y-4">
              ...
              <Link href="/courses" className="block text-cyan-400 font-medium" onClick={() => setIsMobileMenuOpen(false)}>Courses</Link>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-20">
          ...
          <div className="group relative overflow-hidden rounded-2xl border border-cyan-400/30 hover:border-cyan-400 transition-all duration-300 hover:shadow-lg hover:shadow-cyan-400/25">
            ...
            <div className="p-6 text-white bg-gray-900/95 backdrop-blur-sm rounded-b-2xl">
              ...
              <button 
                onClick={() => alert('Sorry! Grade 9th - Aarambh 2.0 course is not available on this site because we do not have permission to offer these courses directly. Please visit the official Next Toppers website for enrollment.')}
                className="w-full px-6 py-3 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-lg font-semibold hover:scale-105 transition-transform duration-300"
              >
                Enroll Now
              </button>
            </div>
          ...
          <div className="group relative overflow-hidden rounded-2xl border border-pink-400/30 hover:border-pink-400 transition-all duration-300 hover:shadow-lg hover:shadow-pink-400/25">
            ...
            <div className="p-6 text-white bg-gray-900/95 backdrop-blur-sm rounded-b-2xl">
              ...
              <button 
                onClick={() => alert('Sorry! Grade 10th - Aarambh course is not available on this site because we do not have permission to offer these courses directly. Please visit the official Next Toppers website for enrollment.')}
                className="w-full px-6 py-3 bg-gradient-to-r from-pink-500 to-red-500 rounded-lg font-semibold hover:scale-105 transition-transform duration-300"
              >
                Enroll Now
              </button>
            </div>
          ...
          <div className="group relative overflow-hidden rounded-2xl border border-green-400/30 hover:border-green-400 transition-all duration-300 hover:shadow-lg hover:shadow-green-400/25">
            ...
            <div className="p-6 text-white bg-gray-900/95 backdrop-blur-sm rounded-b-2xl">
              ...
              <button 
                onClick={() => alert('Sorry! Grade 11th - Science course is not available on this site because we do not have permission to offer these courses directly. Please visit the official Next Toppers website for enrollment.')}
                className="w-full px-6 py-3 bg-gradient-to-r from-green-500 to-emerald-500 rounded-lg font-semibold hover:scale-105 transition-transform duration-300"
              >
                Enroll Now
              </button>
            </div>
          ...
          <div className="group relative overflow-hidden rounded-2xl border border-purple-400/30 hover:border-purple-400 transition-all duration-300 hover:shadow-lg hover:shadow-purple-400/25">
            ...
            <div className="p-6 text-white bg-gray-900/95 backdrop-blur-sm rounded-b-2xl">
              ...
              <button 
                onClick={() => alert('Sorry! Grade 11th - Humanities course is not available on this site because we do not have permission to offer these courses directly. Please visit the official Next Toppers website for enrollment.')}
                className="w-full px-6 py-3 bg-gradient-to-r from-purple-500 to-indigo-500 rounded-lg font-semibold hover:scale-105 transition-transform duration-300"
              >
                Enroll Now
              </button>
            </div>
